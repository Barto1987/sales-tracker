...
import {loadStore,saveStore,importBackupObject} from './storage.js?v=234';
import {TARGETS,generalStats,agencyStats,excellentStats,excellentBreakdown,communityStats,teamStats,inflowOf} from './engines.js?v=234';
import {initParser,parsePDF} from './parser.js?v=234';
...
function saveParsed(){
 ...
 const contract={id:'C-'+Date.now(),date:$('contractDate').value,offer:parsed.meta.offer,client:parsed.meta.client||'Da verificare',vat:parsed.meta.vat,prospect,mnp,agent,includeAgency,status:'Valido',pdfRef:parsed.filename,notes:'Sales Tracker 2.3.4',services:[]};
