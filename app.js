import {uploadPdfCloud,openPdfCloud,pdfCloudExists,pdfCloudProbe} from './cloud-pdf-minimal.js?v=3146';
...
import {loadStore,saveStore,importBackupObject} from './storage.js?v=3146';
import {TARGETS,generalStats,agencyStats,agencyBreakdown,excellentStats,excellentBreakdown,communityStats,communityBreakdown,teamStats,teamBreakdown,availableMonths,customerList,customerDashboard,customerKey,inflowOf,communityRulesForMonth} from './engines.js?v=3146';
import {savePdf,openPdf,deletePdf,getPdf} from './pdf-store.js?v=3146';
import {initParser,parsePDF} from './parser.js?v=3146';
import {createAutoBackup,getAutoBackupMeta,getFullBackupMeta,downloadDatabaseBackup,downloadCompleteBackup,restoreCompleteBackup,getArchiveStats,formatBytes,formatDate} from './backup.js?v=3146';
import {exportSync,readSyncFile,previewMerge,applyMerge,getSyncMeta} from './sync.js?v=3146';
import {regulationGroups} from './regulations.js?v=3146';
import {currentMonthKey,monthLabel,quarterFromMonth,availablePeriodMonths,ensurePeriodState,periodStatusLabel,periodStatusIcon,applyGlobalMonth} from './periods.js?v=3146';
import {cloudLogin,cloudLogout,cloudInfo,uploadLocalFirst,downloadAndMerge,syncNow,bootstrapLinkedCloud,queueCloudPush,getCloudMeta,isCloudLinked,getCloudSession,getCloudEmail,setCloudEmail,runCloudDiagnostics,readPrimaryCloudStoreRaw} from './cloud.js?v=3146';
import {commissionsForPeriod} from './commissions.js?v=3146';
...
function renderArchive(){
 ...
 document.querySelectorAll('[data-pdf-diagnostic]').forEach(b=>b.onclick=()=>diagnosePdfCloud(b.dataset.pdfDiagnostic));
...
<h3>Conferma manuale trimestrale</h3><p class="muted">Solo Gara Agenzia Piramis, separata dal target individuale. Se raggiunta, gli extra vengono pagati a 60 gg dalla chiusura trimestre (Q3 2026 → novembre 2026).</p>
