...
export function emptyStore(){
  return {
    ...
    settings:{
      ...
      agencyQuarterResults:{
        '2026-Q3':{core:'pending',fixed:'pending',digital:'pending',updatedAt:null}
      }
    },
...
export function loadStore(){
  ...
  if(v2){
    try{
      ...
      store.settings.agencyQuarterResults['2026-Q3']=store.settings.agencyQuarterResults['2026-Q3']||{core:'pending',fixed:'pending',digital:'pending',updatedAt:null};
