...
export function emptyStore(){
  return {
    ...
    settings:{
      ...
      agents:['Francesco','Jacopo','Luciano'],agencyQuarterResults:{'2026-Q3':{core:'pending',fixed:'pending',digital:'pending',updatedAt:null}},agencyQuarterLocks:{},communityRankings:{}
    },
...
export function loadStore(){
  ...
  if(v2){
    try{
      ...
      store.settings.agents=store.settings.agents||['Francesco','Jacopo','Luciano'];store.settings.agencyQuarterResults=store.settings.agencyQuarterResults||{};store.settings.agencyQuarterResults['2026-Q3']=store.settings.agencyQuarterResults['2026-Q3']||{core:'pending',fixed:'pending',digital:'pending',updatedAt:null};store.settings.agencyQuarterLocks=store.settings.agencyQuarterLocks||{};store.settings.communityRankings=store.settings.communityRankings||{};
